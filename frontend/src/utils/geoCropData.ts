...
// State-specific crop affinity map (ICAR agronomic data)
// Each state lists crops with a priority score (0-1) for regional suitability
export const STATE_CROPS_MAP: Record<string, { crop: string; priority: number }[]> = {
  'Karnataka': [
    { crop: 'Rice', priority: 0.95 }, { crop: 'Sugarcane', priority: 0.92 }, { crop: 'Cotton', priority: 0.88 },
    { crop: 'Maize', priority: 0.86 }, { crop: 'Groundnut', priority: 0.84 }, { crop: 'Sorghum', priority: 0.82 },
    { crop: 'Mango', priority: 0.80 }, { crop: 'Coffee', priority: 0.78 }, { crop: 'Coconut', priority: 0.76 },
    { crop: 'Turmeric', priority: 0.74 }, { crop: 'Chilli', priority: 0.72 }, { crop: 'Sunflower', priority: 0.70 },
  ],
  'Maharashtra': [
    { crop: 'Sugarcane', priority: 0.96 }, { crop: 'Cotton', priority: 0.94 }, { crop: 'Soybean', priority: 0.92 },
    { crop: 'Onion', priority: 0.90 }, { crop: 'Pomegranate', priority: 0.88 }, { crop: 'Grapes', priority: 0.86 },
    { crop: 'Rice', priority: 0.84 }, { crop: 'Wheat', priority: 0.80 }, { crop: 'Groundnut', priority: 0.78 },
    { crop: 'Sorghum', priority: 0.76 }, { crop: 'Pearl Millet', priority: 0.74 }, { crop: 'Turmeric', priority: 0.72 },
  ],
  'Punjab': [
    { crop: 'Wheat', priority: 0.97 }, { crop: 'Rice', priority: 0.95 }, { crop: 'Cotton', priority: 0.90 },
    { crop: 'Maize', priority: 0.88 }, { crop: 'Sugarcane', priority: 0.86 }, { crop: 'Potato', priority: 0.84 },
    { crop: 'Mustard', priority: 0.82 }, { crop: 'Barley', priority: 0.78 }, { crop: 'Chickpea', priority: 0.76 },
  ],
  'Uttar Pradesh': [
    { crop: 'Wheat', priority: 0.96 }, { crop: 'Rice', priority: 0.94 }, { crop: 'Sugarcane', priority: 0.93 },
    { crop: 'Potato', priority: 0.90 }, { crop: 'Mustard', priority: 0.88 }, { crop: 'Maize', priority: 0.85 },
    { crop: 'Mango', priority: 0.83 }, { crop: 'Chickpea', priority: 0.80 }, { crop: 'Lentil', priority: 0.78 },
    { crop: 'Onion', priority: 0.76 }, { crop: 'Banana', priority: 0.74 },
  ],
  'Tamil Nadu': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Coconut', priority: 0.94 }, { crop: 'Sugarcane', priority: 0.92 },
    { crop: 'Banana', priority: 0.90 }, { crop: 'Groundnut', priority: 0.88 }, { crop: 'Cotton', priority: 0.85 },
    { crop: 'Maize', priority: 0.82 }, { crop: 'Mango', priority: 0.80 }, { crop: 'Turmeric', priority: 0.78 },
    { crop: 'Chilli', priority: 0.76 }, { crop: 'Finger Millet', priority: 0.74 },
  ],
  'Andhra Pradesh': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Cotton', priority: 0.93 }, { crop: 'Chilli', priority: 0.91 },
    { crop: 'Groundnut', priority: 0.89 }, { crop: 'Sugarcane', priority: 0.86 }, { crop: 'Maize', priority: 0.84 },
    { crop: 'Mango', priority: 0.82 }, { crop: 'Banana', priority: 0.80 }, { crop: 'Turmeric', priority: 0.78 },
    { crop: 'Coconut', priority: 0.76 }, { crop: 'Onion', priority: 0.74 },
  ],
  'Gujarat': [
    { crop: 'Cotton', priority: 0.96 }, { crop: 'Groundnut', priority: 0.94 }, { crop: 'Wheat', priority: 0.90 },
    { crop: 'Rice', priority: 0.86 }, { crop: 'Sugarcane', priority: 0.84 }, { crop: 'Mustard', priority: 0.82 },
    { crop: 'Pearl Millet', priority: 0.80 }, { crop: 'Banana', priority: 0.78 }, { crop: 'Mango', priority: 0.76 },
    { crop: 'Pomegranate', priority: 0.74 }, { crop: 'Onion', priority: 0.72 },
  ],
  'Haryana': [
    { crop: 'Wheat', priority: 0.96 }, { crop: 'Rice', priority: 0.94 }, { crop: 'Mustard', priority: 0.91 },
    { crop: 'Cotton', priority: 0.88 }, { crop: 'Sugarcane', priority: 0.86 }, { crop: 'Pearl Millet', priority: 0.84 },
    { crop: 'Barley', priority: 0.80 }, { crop: 'Potato', priority: 0.78 }, { crop: 'Maize', priority: 0.76 },
  ],
  'Madhya Pradesh': [
    { crop: 'Soybean', priority: 0.96 }, { crop: 'Wheat', priority: 0.94 }, { crop: 'Rice', priority: 0.90 },
    { crop: 'Chickpea', priority: 0.88 }, { crop: 'Cotton', priority: 0.86 }, { crop: 'Maize', priority: 0.84 },
    { crop: 'Lentil', priority: 0.82 }, { crop: 'Mustard', priority: 0.80 }, { crop: 'Sugarcane', priority: 0.78 },
    { crop: 'Onion', priority: 0.76 }, { crop: 'Groundnut', priority: 0.74 },
  ],
  'Rajasthan': [
    { crop: 'Pearl Millet', priority: 0.96 }, { crop: 'Mustard', priority: 0.94 }, { crop: 'Wheat', priority: 0.92 },
    { crop: 'Barley', priority: 0.88 }, { crop: 'Chickpea', priority: 0.86 }, { crop: 'Groundnut', priority: 0.84 },
    { crop: 'Cotton', priority: 0.82 }, { crop: 'Maize', priority: 0.80 }, { crop: 'Sorghum', priority: 0.78 },
    { crop: 'Mungbean', priority: 0.76 }, { crop: 'Mothbeans', priority: 0.74 },
  ],
  'West Bengal': [
    { crop: 'Rice', priority: 0.97 }, { crop: 'Jute', priority: 0.94 }, { crop: 'Potato', priority: 0.92 },
    { crop: 'Wheat', priority: 0.88 }, { crop: 'Maize', priority: 0.84 }, { crop: 'Mustard', priority: 0.82 },
    { crop: 'Mango', priority: 0.80 }, { crop: 'Banana', priority: 0.78 }, { crop: 'Lentil', priority: 0.76 },
  ],
  'Telangana': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Cotton', priority: 0.94 }, { crop: 'Maize', priority: 0.90 },
    { crop: 'Chilli', priority: 0.88 }, { crop: 'Soybean', priority: 0.86 }, { crop: 'Turmeric', priority: 0.84 },
    { crop: 'Mango', priority: 0.82 }, { crop: 'Sugarcane', priority: 0.80 }, { crop: 'Groundnut', priority: 0.78 },
  ],
  'Kerala': [
    { crop: 'Coconut', priority: 0.97 }, { crop: 'Rice', priority: 0.94 }, { crop: 'Banana', priority: 0.92 },
    { crop: 'Coffee', priority: 0.90 }, { crop: 'Papaya', priority: 0.86 }, { crop: 'Mango', priority: 0.84 },
    { crop: 'Groundnut', priority: 0.80 }, { crop: 'Turmeric', priority: 0.78 },
  ],
  'Bihar': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Wheat', priority: 0.94 }, { crop: 'Maize', priority: 0.92 },
    { crop: 'Potato', priority: 0.90 }, { crop: 'Lentil', priority: 0.86 }, { crop: 'Sugarcane', priority: 0.84 },
    { crop: 'Mango', priority: 0.82 }, { crop: 'Banana', priority: 0.80 }, { crop: 'Onion', priority: 0.78 },
  ],
  'Odisha': [
    { crop: 'Rice', priority: 0.97 }, { crop: 'Groundnut', priority: 0.90 }, { crop: 'Sugarcane', priority: 0.88 },
    { crop: 'Maize', priority: 0.86 }, { crop: 'Jute', priority: 0.84 }, { crop: 'Cotton', priority: 0.82 },
    { crop: 'Mango', priority: 0.80 }, { crop: 'Turmeric', priority: 0.78 }, { crop: 'Coconut', priority: 0.76 },
  ],
  'Chhattisgarh': [
    { crop: 'Rice', priority: 0.97 }, { crop: 'Maize', priority: 0.90 }, { crop: 'Soybean', priority: 0.88 },
    { crop: 'Wheat', priority: 0.84 }, { crop: 'Chickpea', priority: 0.82 }, { crop: 'Lentil', priority: 0.80 },
    { crop: 'Sugarcane', priority: 0.78 }, { crop: 'Groundnut', priority: 0.76 },
  ],
  'Jharkhand': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Maize', priority: 0.92 }, { crop: 'Wheat', priority: 0.88 },
    { crop: 'Potato', priority: 0.86 }, { crop: 'Lentil', priority: 0.82 }, { crop: 'Mango', priority: 0.80 },
    { crop: 'Finger Millet', priority: 0.78 }, { crop: 'Groundnut', priority: 0.76 },
  ],
  'Assam': [
    { crop: 'Rice', priority: 0.97 }, { crop: 'Jute', priority: 0.92 }, { crop: 'Potato', priority: 0.88 },
    { crop: 'Banana', priority: 0.86 }, { crop: 'Sugarcane', priority: 0.84 }, { crop: 'Maize', priority: 0.82 },
    { crop: 'Mustard', priority: 0.80 }, { crop: 'Orange', priority: 0.78 },
  ],
  'Himachal Pradesh': [
    { crop: 'Apple', priority: 0.97 }, { crop: 'Wheat', priority: 0.92 }, { crop: 'Maize', priority: 0.90 },
    { crop: 'Rice', priority: 0.86 }, { crop: 'Barley', priority: 0.84 }, { crop: 'Potato', priority: 0.82 },
    { crop: 'Tomato', priority: 0.80 },
  ],
  'Uttarakhand': [
    { crop: 'Rice', priority: 0.94 }, { crop: 'Wheat', priority: 0.92 }, { crop: 'Sugarcane', priority: 0.90 },
    { crop: 'Soybean', priority: 0.86 }, { crop: 'Potato', priority: 0.84 }, { crop: 'Apple', priority: 0.82 },
    { crop: 'Maize', priority: 0.80 }, { crop: 'Lentil', priority: 0.78 },
  ],
  'Goa': [
    { crop: 'Rice', priority: 0.96 }, { crop: 'Coconut', priority: 0.94 }, { crop: 'Mango', priority: 0.90 },
    { crop: 'Banana', priority: 0.86 }, { crop: 'Groundnut', priority: 0.82 }, { crop: 'Sugarcane', priority: 0.80 },
  ],
};

// Get crops relevant to a specific state (with priority scores)
export function getCropsForState(stateName: string): { crop: string; priority: number }[] {
  return STATE_CROPS_MAP[stateName] || CROPS_LIST.map((c, i) => ({ crop: c, priority: Math.max(0.65, 0.90 - i * 0.02) }));
}
